...
//
//public class GameIncomeTest {
//
//    @Test
//    public void testIncomeFeatureIncreasesCoinsByOneForEachPlayer() {
...
//            game.getCurrentPlayer().action("Income", game.getCurrentPlayer());
//            assertEquals(currentPlayerCoins + 1,game.getCurrentPlayer().getCoins());
