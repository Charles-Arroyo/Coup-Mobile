...
public class CounterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newFivebtn = findViewById(R.id.addSub5_btn);
        ...
        increaseBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                numberTxt.setText(String.valueOf(counter = counter + 2));
            }
        });
        ...
        newFivebtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CounterActivity.this, CounterActivity2.class);
