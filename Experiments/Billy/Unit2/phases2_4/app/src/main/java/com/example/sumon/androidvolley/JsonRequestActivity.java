...
public class JsonRequestActivity extends Activity implements OnClickListener {
    ...
    private Button btnJsonObj, btnJsonArray, btnSendJsonObj;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSendJsonObj = (Button) findViewById(R.id.btnSendJsonObj);
        ...
        btnSendJsonObj.setOnClickListener(this);
    }
    ...
    /**
     * Make a json request which sends a json object
     * */
    private void sendJsonObjReq(){
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Method.POST,
                Const.URL_POST_CREATE_USER, jsonObject,
                new Response.Listener<JSONObject>() {
